...
namespace fixbug {
class GerFriendListsResponse;
class GerFriendListsResponseDefaultTypeInternal;
extern GerFriendListsResponseDefaultTypeInternal _GerFriendListsResponse_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GerFriendListsResponse* Arena::CreateMaybeMessage<::fixbug::GerFriendListsResponse>(Arena*);
...
class GerFriendListsResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GerFriendListsResponse) */ {
 public:
  GerFriendListsResponse();
  virtual ~GerFriendListsResponse();

  GerFriendListsResponse(const GerFriendListsResponse& from);
  GerFriendListsResponse(GerFriendListsResponse&& from) noexcept
    : GerFriendListsResponse() {
    *this = ::std::move(from);
  }

  inline GerFriendListsResponse& operator=(const GerFriendListsResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GerFriendListsResponse& operator=(GerFriendListsResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GerFriendListsResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GerFriendListsResponse* internal_default_instance() {
    return reinterpret_cast<const GerFriendListsResponse*>(
               &_GerFriendListsResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GerFriendListsResponse& a, GerFriendListsResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GerFriendListsResponse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GerFriendListsResponse* New() const final {
    return CreateMaybeMessage<GerFriendListsResponse>(nullptr);
  }

  GerFriendListsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GerFriendListsResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GerFriendListsResponse& from);
  void MergeFrom(const GerFriendListsResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GerFriendListsResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GerFriendListsResponse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GerFriendListsResponse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GerFriendListsResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GerFriendListsResponse::has_result() const {
  return _internal_has_result();
}
inline void GerFriendListsResponse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GerFriendListsResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GerFriendListsResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GerFriendListsResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GerFriendListsResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GerFriendListsResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GerFriendListsResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GerFriendListsResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GerFriendListsResponse.result)
  return _internal_mutable_result();
}
inline void GerFriendListsResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GerFriendListsResponse.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GerFriendListsResponse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GerFriendListsResponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GerFriendListsResponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GerFriendListsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GerFriendListsResponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GerFriendListsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GerFriendListsResponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GerFriendListsResponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GerFriendListsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GerFriendListsResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GerFriendListsResponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GerFriendListsResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GerFriendListsResponse.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GerFriendListsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GerFriendListsResponse.friend_list)
  return friend_list_;
}
